      ...
      <Box minH={'78vh'} borderRadius='lg' m={{ base: 5, md: 5, lg: 5 }} p={{ base: 4, lg: 5 }}>
        <Box>
          <VStack spacing={{ base: 3, md: 6, lg: 10 }}>
            ...
            <Stack spacing={{ base: 4, md: 4, lg: 4 }} direction={{ base: 'column', md: 'row' }}>
              <Box
                ...
                <VStack spacing={3}>
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      ...
                      <Input type='text' name='name' placeholder='Niko Nikić' />
                    </InputGroup>
                  </FormControl>
                  ...
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      ...
                      <Input type='email' name='email' placeholder='primjer@test.ba' />
                    </InputGroup>
                  </FormControl>
                  ...
                  <FormControl isRequired>
                    ...
                    <Textarea
                      name='message'
                      placeholder='Napišite poruku koju nam želite poslati ovdje!'
                      rows={4}
                      resize='none'
                    />
                  </FormControl>
